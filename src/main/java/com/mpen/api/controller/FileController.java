        ...
        return new Callable<NetworkResult<Object>>() {
            ...
            public NetworkResult<Object> call() throws Exception {
                ...
                case Constants.UPLOAD_CMD_FILE:
                    fileSavePath = fileService.saveFile(fileParam.getFile(), FileUtils.CMD_FILE);
                    result.setSuccess(
                ...
                case Constants.UPLOAD_ORALTEST_RECORDING:
                    fileSavePath = fileService.saveFile(fileParam.getFile(), FileUtils.RECORDING);
        ...
        return new Callable<NetworkResult<Object>>() {
            ...
            public NetworkResult<Object> call() throws Exception {
                ...
                if (Constants.DOWNLOAD_BOOK.equals(fileParam.getAction())) {
                    ...
                    return RsHelper.success(resourceBookService.downloadBookZip(fileParam.getUuid()));
                }
