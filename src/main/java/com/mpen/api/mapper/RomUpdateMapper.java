...
public interface RomUpdateMapper {
    ...
    DdbRomUpdate get(@Param("name") String name, @Param("type") DdbPePen.Type type);
    ...
    DdbRomUpdate getByItem(@Param("item") String item, @Param("name") String name, @Param("type") DdbPePen.Type type);
}
