...
public final class OralEvaluationUtil {
    private static final String YUNZHISHENG_URL = "http://edu.hivoice.cn/eval/mp3";
    ...
    public static EvalResult evaluation(OralTestDetail detail, String staAnswer) throws SdkException {
        ...
        bodyMap.put(BODY_TEXT, staAnswer);
        bodyMap.put(BODY_MODE, DEFAULT_MODE);
        try {
            final String result = CommUtil.post(YUNZHISHENG_URL, headerMap, bodyMap, BODY_VOICE,
